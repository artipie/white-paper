...
Architecute is consisted of 4 essential parts:
\begin{enumerate}
	\item Artipie engine
...
Artipie engine is a java application, which exposes an HTTP endpoint for repository access and managment operations.
...
Diving into storage section, artipie asked to use s3 as artifact storage.   
