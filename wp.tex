...
\begin{itemize}
  \item java.io.{In,Out}putStream's based option. 
  \item RxJava 3 based option.
	\item CompletableFuture and Java 9 Flow based option.
\end{itemize}

The java.io.{In,Out}putStream's approach has a conceptual drawback: it's blocking nature,
...
ones, since CompletableFuture and Flow-based interface can be implemented in a 
high-performance way and accordance with all the mentioned requirements.
